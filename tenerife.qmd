...
<jct>Alerta, fora mirar es document des PHI, i limitant-nos únicament a nes dataframe que tenim, no podem sabre a quins rius principals pertanyen es afluents, de manera que no podem vincular lleres principals amb les seves secundàries. Realment ho estàs fent amb CONQUES</jct>
```{r}
