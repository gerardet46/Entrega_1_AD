...
En aquest gràfic podem observar que, a mesura que augmenta elm nombre d'afluents, la diferència entre la longitud 2d i la longitud 3d va creixent. Llavors, això ens indica que la longitud 3d és una mica més gran que la de dues dimensions, i a mesura que augmenten el nombre d'afluents, la diferència de les longituts creix per la recurrència d'aquestes sumes.
