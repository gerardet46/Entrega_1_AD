...
=======
>>>>>>> 3a2938773f67761739c67b43f0aa62845c7aa312
...
```
## Còmput de lleres
Un altre fet que pot resultar rellevant és comptabilitzar els tipus de lleres segons distintes clasificacions. Per exemple, podem identificar les lleres que tenen més afluents.Mostrem en un diagrama de barres les 10 més nombroses.
...
Calcularem la recta de regresió on la variable independent sirà la longitud en 2d, i la variable dependent, sirà la longitud en 3 dimensions de la suma dels afluents.

```{r}
longituts_2d=torrents$cauce_longitud_2d
longituts_3d=torrents$cauce_longitud_3d
plot(longituts_2d,longituts_3d,main = "Diagrama de dispersión", xlab = "X", ylab = "Y", pch=19)
# Ajustam el modelo de regresió lineal
model <- lm(longituts_3d ~ longituts_2d)
plot(longituts_3d~longituts_2d, main = "Recta de Regresión Lineal", xlab = "Longitud 2d", ylab = "longitud 3d",col="blue", pch = 19,data=faithful)+abline(model, col = "red", lwd = 2,data=faithful)
````
